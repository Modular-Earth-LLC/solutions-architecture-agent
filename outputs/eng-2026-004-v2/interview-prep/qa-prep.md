# Q&A Preparation — 15+ Anticipated Panel Questions
## AI-Driven Prior Authorization | Autonomize AI Interview
### Paul Prae | Principal AI Engineer & Architect

> **Format rule**: Every answer targets under 60 seconds spoken aloud. If you're going longer, cut to the core and offer to elaborate. Bridge to slides where relevant.

---

## Kris Nair (COO) — Business Case & Risk

Kris owns the business. Lead with outcomes, not technology. Cite real numbers. Show you understand that AI is a means to a business end.
...
**Bridge to slide**: Slide 2 (Executive Summary) — the three Altais metrics are on that slide.
...
**Bridge to slide**: Slide 9 (Implementation Roadmap).
...
## Suresh Gopalakrishnan (Solutions Architect, 4.5 years Elevance Health) — Integration Depth

Suresh has been inside a major payer. He knows exactly what breaks. Show him you've thought through the hard integration problems. Reference your pattern experience without overclaiming implementation specifics.
...
**Bridge to slide**: Slide 8 (LLMOps Pipeline).
...
## Ujjwal Rajbhandari (VP Engineering, ex-Google Cloud/Dell, TOGAF) — Engineering Rigor

Ujjwal is an enterprise architect. He's looking for sound engineering judgment, trade-off awareness, and system-level thinking. He'll probe the 'why' behind choices.
...
**Bridge to slide**: Slide 10 (Future State & Scaling) — the trade-off table is there.
...
## General Skepticism — Any Panelist
...
**Bridge phrases when shifting to a slide:**
- "Let me point you to slide [N] — that's where I've captured..."
- "The diagram on slide [N] shows this more clearly..."
- "That's actually the trade-off table on slide 10 — happy to walk through it."

**If you're asked something you don't know:**
- "That's a great discovery question — here's what I'd want to find out and why it matters for the architecture: [brief statement]. I'd rather surface that now than make an assumption that breaks in integration."

**Time check**: If any answer runs over 60 seconds, you've gone deep enough. Stop and offer: "I can go deeper on any piece of that — what's most relevant to your context?"
